...
const OpenToWork = () => {
  ...
  return (
    <div className=" h-[54vh] md:h-[70vh] lg:h-[75vh] relative pt-8 md:pt-16 lg:pt-32 w-full lg:pl-56 lg:pr-12 lg:mr-12  bg-gray-100">
      <div className="pl-64 pb-0.5">
        {carousel == 0 && (
          <div className="grid grid-cols-10 absolute lg:pl-56 animate-slide w-full space-x-16  ">
            <div className="col-span-10 md:col-span-10 my-auto lg:col-span-4 p-1">
              <h1 className=" text-amber-900 text-2xl md:text-3xl lg:text-4xl font-normal w-[90%] my-10 leading-11">
                Let the right people know you’re open to work
              </h1>
              <p className="text-black text-sm md:text-xl lg:text-3xl font-extralight w-[90%] my-10 leading-11">
            ...
            <button onClick={handleNext}>
              <AiFillRightCircle className="absolute right-4 lg:right-2 top-[100%] lg:top-[50%] h-12 w-12 text-gray-700 hover:text-black" />
            </button>
          </div>
        )}
        {carousel == 1 && (
          <div className="grid grid-cols-10 absolute lg:pl-56 animate-slide w-full space-x-16  ">
            ...
            <button
              onClick={handlePrev}
              className="absolute -left-14 lg:left-0 top-[100%] lg:top-[50%]"
            >
